...
// template Log(T)
// {
//     void Debug(message, args ...)
//     {
//         printf(message, args);
//     }
//     void Trace(message, args ...)
//     {
//         printf(message, args);
//     }
// }
...
//                     try
//                     {
//                         printf(toStringz("["~timeString~"]["~logName[level]~"]["~Thread.getThis.name~"] "~message~"\n"));
//                     }
//                     catch(Exception)
//                     {
//                         printf(toStringz("["~timeString~"]["~logName[level]~"][ERROR_GETTING_THREAD_NAME] "~message~"\n"));
//                     }
//                 }
//             }
//         }

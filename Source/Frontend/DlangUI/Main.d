...
extern (C) int UIAppMain(string[] args) 
{
    ...
    Window window = Platform.instance.createWindow("Drill", null,WindowFlag.Resizable,940,560);
    ...
    window.mainWidget = parseML(q{
        VerticalLayout {
			...
			EditLine { id:searchInput; layoutWidth: fill; fontSize: 200%; }

			StringListWidget { id: list; layoutHeight: fill; layoutWidth: fill; }
			TextWidget { text: "if you can read this then there is a bug, submit it!" }
